...
def initRoutes():
    ...
    r.connect('/defence', controller='welcome', action='defence')
    r.connect('/damage_in', controller='welcome', action='damage_in')
    r.connect('/damage', controller='welcome', action='damage')
    r.connect('/speed', controller='welcome', action='speed')
